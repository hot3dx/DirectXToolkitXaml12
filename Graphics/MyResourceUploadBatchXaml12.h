//--------------------------------------------------------------------------------------
// File: MyResourceUploadBatch.h
//
// Copyright (c) Microsoft Corporation. All rights reserved.
// Licensed under the MIT License.
// portions Copyright (c) 2020 Jeff Kubitz - hot3dx
...
namespace DirectX
{
    namespace DXTKXAML12
    {
        ...
        public:
            ...
            Concurrency::task<void> __cdecl EndXaml(
                _In_ ID3D12CommandQueue* commandQueue);

            void _cdecl SetGPUHandle(_In_ HANDLE handle);
            HANDLE _cdecl GetGPUHandle();
