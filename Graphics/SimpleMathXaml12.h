...
namespace std
{
    ...
    template<> struct less<DirectX::DXTKXAML12::SimpleMath::Rectangle>
    {
        bool operator()(const DirectX::DXTKXAML12::SimpleMath::Rectangle& r1, const DirectX::DXTKXAML12::SimpleMath::Rectangle& r2) const
        {
            return ((r1.x < r2.x)
                    || ((r1.x == r2.x) && (r1.y < r2.y))
    ...
    template<> struct less<DirectX::DXTKXAML12::SimpleMath::Vector2>
    {
        bool operator()(const DirectX::DXTKXAML12::SimpleMath::Vector2& V1, const DirectX::DXTKXAML12::SimpleMath::Vector2& V2) const
        {
            return ((V1.x < V2.x) || ((V1.x == V2.x) && (V1.y < V2.y)));
        }
    };

    template<> struct less<DirectX::DXTKXAML12::SimpleMath::Vector3>
    {
        bool operator()(const DirectX::DXTKXAML12::SimpleMath::Vector3& V1, const DirectX::DXTKXAML12::SimpleMath::Vector3& V2) const
        {
            return ((V1.x < V2.x)
                    || ((V1.x == V2.x) && (V1.y < V2.y))
    ...
    template<> struct less<DirectX::DXTKXAML12::SimpleMath::Vector4>
    {
        bool operator()(const DirectX::DXTKXAML12::SimpleMath::Vector4& V1, const DirectX::DXTKXAML12::SimpleMath::Vector4& V2) const
        {
            return ((V1.x < V2.x)
                    || ((V1.x == V2.x) && (V1.y < V2.y))
                    || ((V1.x == V2.x) && (V1.y == V2.y) && (V1.z < V2.z))
    ...
    template<> struct less<DirectX::DXTKXAML12::SimpleMath::Matrix>
    {
        bool operator()(const DirectX::DXTKXAML12::SimpleMath::Matrix& M1, const DirectX::DXTKXAML12::SimpleMath::Matrix& M2) const
        {
    ...
    template<> struct less<DirectX::DXTKXAML12::SimpleMath::Plane>
    {
        bool operator()(const DirectX::DXTKXAML12::SimpleMath::Plane& P1, const DirectX::DXTKXAML12::SimpleMath::Plane& P2) const
        {
            return ((P1.x < P2.x)
                    || ((P1.x == P2.x) && (P1.y < P2.y))
    ...
    template<> struct less<DirectX::DXTKXAML12::SimpleMath::Quaternion>
    {
        bool operator()(const DirectX::DXTKXAML12::SimpleMath::Quaternion& Q1, const DirectX::DXTKXAML12::SimpleMath::Quaternion& Q2) const
        {
            return ((Q1.x < Q2.x)
                    || ((Q1.x == Q2.x) && (Q1.y < Q2.y))
    ...
    template<> struct less<DirectX::DXTKXAML12::SimpleMath::Color>
    {
        bool operator()(const DirectX::DXTKXAML12::SimpleMath::Color& C1, const DirectX::DXTKXAML12::SimpleMath::Color& C2) const
        {
            return ((C1.x < C2.x)
                    || ((C1.x == C2.x) && (C1.y < C2.y))
    ...
    template<> struct less<DirectX::DXTKXAML12::SimpleMath::Ray>
    {
        bool operator()(const DirectX::DXTKXAML12::SimpleMath::Ray& R1, const DirectX::DXTKXAML12::SimpleMath::Ray& R2) const
        {
    ...
    template<> struct less<DirectX::DXTKXAML12::SimpleMath::Viewport>
    {
        bool operator()(const DirectX::DXTKXAML12::SimpleMath::Viewport& vp1, const DirectX::DXTKXAML12::SimpleMath::Viewport& vp2) const
        {
