...
XMFLOAT3 XM_CALLCONV Hot3dx::CHot3dxD3D12Geometry::directionBetweenPoints(XMFLOAT3 _from, XMFLOAT3 _to)
{
	XMFLOAT3 v;
	v.x = (_to.x - _from.x);
	v.y = (_to.y - _from.y);
...
double XM_CALLCONV Hot3dx::CHot3dxD3D12Geometry::Magnitude(XMFLOAT3 v)
{
	return sqrt((v.x * v.x) + (v.y * v.y) + (v.z * v.z));
}

double XM_CALLCONV Hot3dx::CHot3dxD3D12Geometry::AngleBetweenTwoLines(XMFLOAT3 v, XMFLOAT3 s)
{
	double angle = (((v.x * s.x) + (v.y * s.y) + (v.z * s.z)) / (Magnitude(v) * Magnitude(s)));
	return cos(angle);
}

void XM_CALLCONV Hot3dx::CHot3dxD3D12Geometry::InitVector(XMFLOAT3 v)
{
	v.x = 0.0F;
	v.y = 0.0F;
	v.z = 0.0F;
...
double XM_CALLCONV Hot3dx::CHot3dxD3D12Geometry::FindPlaneConstant(XMFLOAT3 planeNormal, XMFLOAT3 a)
{
	return (planeNormal.x * a.x) + (planeNormal.y * a.y) + (planeNormal.z * a.z);
}

XMFLOAT3 XM_CALLCONV Hot3dx::CHot3dxD3D12Geometry::FindPlaneNormal(XMFLOAT3 a, XMFLOAT3 b, XMFLOAT3 c)
{
	XMFLOAT3 n,j,k = {}; 
	j.x = a.x - b.x;
	j.y = a.y - b.x;
...
XMFLOAT3 XM_CALLCONV Hot3dx::CHot3dxD3D12Geometry::FindPointIntersectPlane(XMFLOAT3 planeNormal, XMFLOAT3 lineOrigin, XMFLOAT3 lineDirection, float c)
{
...
XMVECTOR XM_CALLCONV Hot3dx::CHot3dxD3D12Geometry::directionBetweenPointsVec(XMVECTOR _from, XMVECTOR _to)
{
...
/*
XMVECTOR Hot3dx::CHot3dxD3D12Geometry::CenterOfFace(CD3D9Face face)
{
...
*/
double XM_CALLCONV Hot3dx::CHot3dxD3D12Geometry::MagnitudeVec(XMVECTOR v)
{
...
double XM_CALLCONV Hot3dx::CHot3dxD3D12Geometry::AngleBetweenTwoLinesVec(XMVECTOR v, XMVECTOR s)
{
...
void XM_CALLCONV Hot3dx::CHot3dxD3D12Geometry::InitVectorVec(XMVECTOR v)
{
	XMVectorSetX(v, 0.0f);
	XMVectorSetY(v, 0.0f);
	XMVectorSetZ(v, 0.0f);
...
XMVECTOR XM_CALLCONV Hot3dx::CHot3dxD3D12Geometry::FindPlaneNormalVec(XMVECTOR a, XMVECTOR b, XMVECTOR c)
{
...
*	a,b,c 3 points of a plane
  */
double XM_CALLCONV Hot3dx::CHot3dxD3D12Geometry::FindPlaneConstantVec(XMVECTOR planeNormal, XMVECTOR a)
{
...
XMVECTOR XM_CALLCONV Hot3dx::CHot3dxD3D12Geometry::FindPointIntersectPlaneVec(XMVECTOR planeNormal, XMVECTOR lineOrigin, XMVECTOR lineDirection, float c)
{
